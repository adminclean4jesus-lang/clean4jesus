...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .phone{background:#0b0f18;border:8px solid #0b0f18;border-radius:38px;box-shadow:0 28px 70px rgba(3,8,29,.38);height:444px;overflow:hidden;position:relative;width:240px}
    ...
    .phone img{height:100%;object-fit:contain;object-position:center;width:100%}
