...
const output = path.join(root, "web", "landing");
...
await Promise.all([
  ...
  copyFile(path.join(assets, "favicon.png"), path.join(output, "favicon.png")),
...
<head>
  ...
  <meta name="description" content="Clean4Jesus reúne protección digital, devocionales cristocéntricos y una comunidad moderada para acompañarte a la libertad.">
  <meta name="theme-color" content="#071F52">
  <link rel="icon" type="image/png" href="/favicon.png">
  <link rel="shortcut icon" type="image/png" href="/favicon.png">
  <link rel="apple-touch-icon" href="/favicon.png">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="Clean4Jesus">
  <meta property="og:url" content="https://clean4jesus.com/">
  <meta property="og:title" content="Clean4Jesus | Protección digital con propósito">
  <meta property="og:description" content="Protección digital, Palabra y comunidad para acompañarte a la libertad.">
  <meta property="og:image" content="https://clean4jesus.com/brand-mark.png">
  <meta property="og:image:alt" content="Escudo con cruz de Clean4Jesus">
  <meta name="twitter:card" content="summary">
  <meta name="twitter:title" content="Clean4Jesus | Protección digital con propósito">
  <meta name="twitter:description" content="Protección digital, Palabra y comunidad para acompañarte a la libertad.">
  <meta name="twitter:image" content="https://clean4jesus.com/brand-mark.png">
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .product-stage{align-items:center;background:var(--navy);display:flex;justify-content:center;min-height:515px;overflow:hidden;padding:34px;position:relative}
    .mobile-product{display:none}
    .phone{aspect-ratio:1081/1999;background:#f7f8fa;border:6px solid #0b0f18;border-radius:34px;box-shadow:0 28px 70px rgba(3,8,29,.38);overflow:hidden;position:relative;width:190px}
    .phone:before{background:#0b0f18;border-radius:50%;content:"";height:10px;left:50%;position:absolute;top:7px;transform:translateX(-50%);width:10px;z-index:2}
    .phone img{display:block;height:100%;object-fit:contain;object-position:top;width:100%}
    .numbers{background:var(--navy-deep);color:var(--white);padding:78px 0}
    .platforms{background:var(--white);padding:82px 0}.platform-intro{display:flex;gap:48px;justify-content:space-between;margin-bottom:34px}.platform-intro h2{color:var(--navy-deep);font-size:clamp(34px,4.6vw,60px);letter-spacing:-.05em;line-height:1.04;margin:10px 0 0;max-width:650px}.platform-intro p{color:var(--muted);font-size:17px;max-width:430px}.platform-grid{display:grid;gap:18px;grid-template-columns:1fr 1fr}.platform-card{border:1px solid var(--line);border-radius:24px;padding:36px}.platform-card.android{border-top:6px solid var(--blue)}.platform-card.ios{background:#f5f7ff;border-top:6px solid var(--gold)}.platform-card .os{color:var(--navy);font-size:13px;font-weight:700;letter-spacing:.12em;text-transform:uppercase}.platform-card h3{color:var(--navy-deep);font-size:31px;letter-spacing:-.035em;line-height:1.14;margin:16px 0}.platform-card p{color:#596762;font-size:15px}.platform-card ul{color:#394640;font-size:14px;margin:23px 0;padding-left:19px}.platform-card li{margin:10px 0}.platform-card small{color:#64726d;display:block;font-size:12px;line-height:1.5;margin-top:23px}.how{background:#eef2f8}.how-grid{display:grid;gap:24px;grid-template-columns:1fr 1fr}.flow{background:var(--white);border-radius:24px;padding:36px}.flow h3{color:var(--navy-deep);font-size:27px;margin:10px 0 24px}.flow-step{border-top:1px solid var(--line);display:grid;gap:16px;grid-template-columns:36px 1fr;padding:18px 0}.flow-step b{color:var(--gold);font-size:15px}.flow-step strong{color:var(--navy-deep);display:block;font-size:16px;margin-bottom:4px}.flow-step p{color:var(--muted);font-size:14px;margin:0}.faq{background:var(--white)}.faq-list{border-top:1px solid var(--line)}.faq-item{border-bottom:1px solid var(--line);padding:24px 0}.faq-item h3{color:var(--navy-deep);font-size:19px;margin:0 0 9px}.faq-item p{color:var(--muted);font-size:15px;margin:0;max-width:760px}
    ...
    .screen-card{background:var(--white);border:1px solid var(--line);overflow:hidden}.screen-frame{align-items:flex-end;background:#e8edf8;display:flex;height:440px;justify-content:center;overflow:hidden;padding:18px 34px 0}.screen-frame img{aspect-ratio:1081/1999;background:#f7f8fa;border:5px solid #101724;border-bottom:0;border-radius:28px 28px 0 0;box-shadow:0 18px 35px rgba(9,19,61,.18);display:block;height:auto;object-fit:contain;object-position:top;width:190px}
...
<body>
  ...
  <header class="hero" id="inicio">
    <div class="shell site-nav">
      ...
      <nav class="nav-links" aria-label="Navegación"><a href="#plataformas">Android y iPhone</a><a href="#como-funciona">Cómo funciona</a><a href="#producto">La app</a><a href="#privacidad">Privacidad</a></nav>
      <a class="button" href="https://tally.so/r/Y5BAzv" target="_blank" rel="noopener">Solicitar acceso</a>
    </div>
    <div class="shell hero-grid">
      <div class="hero-copy reveal">
        <div class="eyebrow">Beta cerrada · Android e iPhone</div>
        <h1>Un camino de libertad frente al contenido para adultos.</h1>
        ...
        <p><strong>Clean4Jesus pone a Jesús en el centro de tu camino:</strong> une protección digital, devocionales cristocéntricos y comunidad para acompañarte a la libertad.</p>
        <div class="hero-actions"><a class="button gold" href="https://tally.so/r/Y5BAzv" target="_blank" rel="noopener">Solicitar acceso a la beta <span aria-hidden="true">→</span></a><a class="text-link" href="#plataformas">Ver cómo funciona ↓</a></div>
        <p class="hero-proof">El acceso es limitado mientras validamos la experiencia en dispositivos reales. Sin enlaces de tienda hasta que cada versión esté lista.</p>
      </div>
  ...
  <main id="contenido">
    <section class="platforms" id="plataformas">
      <div class="shell">
        <div class="platform-intro reveal"><div><div class="eyebrow">Elige tu dispositivo</div><h2>La misma misión. Dos protecciones nativas.</h2></div><p>No ocultamos las diferencias: Android protege navegación y apps compatibles con permisos nativos. En iPhone, Apple gestiona los límites por aplicación mediante Screen Time.</p></div>
        <div class="platform-grid reveal">
          <article class="platform-card android"><span class="os">Android · Beta controlada</span><h3>Protección para navegación y apps compatibles.</h3><p>Con tu autorización, la VPN local filtra dominios conocidos y Accesibilidad ayuda a interrumpir las apps que elijas proteger.</p><ul><li>Configura Refugio, PIN y permisos nativos.</li><li>Protege navegación y señales compatibles.</li><li>Vuelve a Clean4Jesus cuando aparece una interrupción.</li></ul><small>La eficacia depende de Android, los permisos y los servicios disponibles; no promete bloqueo perfecto.</small></article>
          <article class="platform-card ios"><span class="os">iPhone · iOS 16 o posterior</span><h3>Límites por app con los controles de Apple.</h3><p>Autoriza Family Controls, elige aplicaciones y asigna un tiempo distinto a cada una. Apple muestra su Shield nativo al alcanzar el límite.</p><ul><li>Sin VPN ni Accesibilidad en iPhone.</li><li>Los nombres y elecciones de apps los mantiene Apple en privado.</li><li>PIN de guardianía para cambios sensibles después de configurar.</li></ul><small>Apple controla el permiso y parte de la experiencia. El contador exacto de uso por app sigue en desarrollo.</small></article>
        </div>
      </div>
    </section>

    <section class="how section" id="como-funciona">
      <div class="shell"><div class="section-title reveal"><div><div class="eyebrow">Un camino claro</div><h2>Configura la protección en tres pasos.</h2></div><p>Solicita acceso, instala la versión adecuada y completa los permisos de tu dispositivo. La app no presenta protección como activa hasta que puedas comprobarla.</p></div>
        <div class="how-grid reveal"><article class="flow"><div class="eyebrow">Android</div><h3>Preparar el Refugio</h3><div class="flow-step"><b>01</b><div><strong>Instala y crea tu acceso de seguridad</strong><p>La beta te guía para instalar la versión y configurar la protección.</p></div></div><div class="flow-step"><b>02</b><div><strong>Autoriza VPN local y Accesibilidad</strong><p>Android te muestra cada permiso antes de activarlo.</p></div></div><div class="flow-step"><b>03</b><div><strong>Elige qué proteger</strong><p>Configura reglas compatibles y verifica el estado del Refugio.</p></div></div></article><article class="flow"><div class="eyebrow">iPhone</div><h3>Activar límites por app</h3><div class="flow-step"><b>01</b><div><strong>Autoriza Family Controls</strong><p>Apple presenta su diálogo de permiso desde Clean4Jesus.</p></div></div><div class="flow-step"><b>02</b><div><strong>Elige apps y define el tiempo</strong><p>Cada aplicación elegida puede tener un límite diario propio.</p></div></div><div class="flow-step"><b>03</b><div><strong>Apple muestra el Shield</strong><p>Al llegar al límite, iOS presenta el bloqueo nativo de la aplicación.</p></div></div></article></div>
      </div>
    </section>
    ...
    <section class="faq section" id="preguntas">
      <div class="shell"><div class="section-title reveal"><div><div class="eyebrow">Preguntas frecuentes</div><h2>Antes de solicitar acceso.</h2></div><p>Preferimos que sepas exactamente qué esperar de la beta y de tu dispositivo.</p></div><div class="faq-list reveal"><article class="faq-item"><h3>¿Puedo descargar la app ya?</h3><p>Estamos trabajando con una beta cerrada y el acceso es limitado. No publicamos enlaces de tienda hasta que la versión correspondiente esté lista y verificada.</p></article><article class="faq-item"><h3>¿Android e iPhone protegen igual?</h3><p>No. Android usa permisos nativos para protección de navegación y apps compatibles. iPhone usa los límites por app de Screen Time y Family Controls de Apple.</p></article><article class="faq-item"><h3>¿Qué pasa con mis datos?</h3><p>Las elecciones de límites permanecen en el dispositivo cuando la plataforma lo permite. Para cuenta y Comunidad tratamos los datos necesarios para prestar el servicio y moderar reportes.</p></article><article class="faq-item"><h3>¿La Comunidad es un canal de emergencia?</h3><p>No. Es un espacio para compartir, pedir oración y reportar contenido conforme a las normas de Clean4Jesus.</p></article></div></div>
    </section>

    <section class="beta" id="beta">
      <div class="shell beta-grid">
        <div class="reveal"><div class="eyebrow" style="color:var(--gold)">Beta cerrada</div><h2>Tu dispositivo merece una protección que entiendas.</h2><p>Solicita acceso para tu plataforma. Te escribiremos si hay cupo para tu dispositivo; el correo de soporte no sustituye atención de emergencia.</p></div>
        <div style="display:flex;flex-wrap:wrap;gap:12px"><a class="button gold" href="https://tally.so/r/Y5BAzv" target="_blank" rel="noopener">Solicitar para Android →</a><a class="button" href="https://tally.so/r/Y5BAzv" target="_blank" rel="noopener">Solicitar para iPhone →</a></div>
      </div>
    </section>
  </main>
