...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .phone{aspect-ratio:1081/1999;background:#f7f8fa;border:6px solid #0b0f18;border-radius:36px;box-shadow:0 28px 70px rgba(3,8,29,.38);overflow:hidden;position:relative;width:220px}
    ...
    .phone img{display:block;height:100%;object-fit:cover;object-position:top;width:100%}
    ...
    .screen-card{background:var(--white);border:1px solid var(--line);overflow:hidden}.screen-frame{background:#e8edf8;height:420px;overflow:hidden;padding:30px 34px 0}.screen-frame img{background:#f7f8fa;border:5px solid #101724;border-bottom:0;border-radius:28px 28px 0 0;box-shadow:0 18px 35px rgba(9,19,61,.18);display:block;height:390px;margin:auto;object-fit:contain;object-position:top;width:211px}
