  ...
  <header class="hero" id="inicio">
    ...
    <div class="shell hero-grid">
      <div class="hero-copy reveal">
        <div class="eyebrow">Protección frente a la pornografía</div>
        <h1>Rompe el ciclo. Recupera tu libertad.</h1>
        ...
        <p><strong>Clean4Jesus bloquea contenido adulto en navegadores y aplicaciones compatibles.</strong> Cuando detecta una señal de riesgo, interrumpe el acceso con una pantalla de protección para ayudarte a detenerte, respirar y volver a elegir.</p>
