...
export function getIosProtectionText(language: SupportedLanguage) {
  ...
  const shieldCopy = {
    es: {
      shieldTitle: "Tu límite de hoy se cumplió",
      shieldMessage: "Ya usaste el tiempo que elegiste para esta app. Tu refugio permanece activo.",
    },
    en: {
      shieldTitle: "Today's limit is complete",
      shieldMessage: "You used the time you chose for this app. Your refuge remains active.",
    },
    fr: {
      shieldTitle: "Votre limite du jour est atteinte",
      shieldMessage: "Vous avez utilisé le temps choisi pour cette app. Votre refuge reste actif.",
    },
    pt: {
      shieldTitle: "Seu limite de hoje foi cumprido",
      shieldMessage: "Você usou o tempo escolhido para este app. Seu refúgio continua ativo.",
    },
  } as const;
