...
const tables = {
  es: {
    ...
    shieldMessage: "Esta aplicación está pausada para ayudarte a cuidar tu decisión. Ciérrala y vuelve a Clean4Jesus desde la pantalla de inicio cuando estés listo.",
    shieldPrimaryAction: "Volver al inicio",
...
const shieldCopy = {
  ...
  en: {
    shieldPrimaryAction: "Return to Home Screen",
    shieldSecondaryAction: "Close",
  },
  fr: {
    shieldPrimaryAction: "Retour à l’accueil",
    shieldSecondaryAction: "Fermer",
  },
  pt: {
    shieldPrimaryAction: "Voltar à tela inicial",
