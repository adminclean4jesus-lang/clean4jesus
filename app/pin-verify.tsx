...
export default function PinVerifyScreen() {
  ...
  return (
    <Screen>
        ...
        <Card.Content style={styles.form}>
          ...
          <View style={styles.helperRow}>
            <View style={styles.helperIcon}>
              <MaterialCommunityIcons color={colors.primaryDark} name="lock-check-outline" size={16} />
            </View>
      ...
      <PrimaryButton disabled={!isCompletePin(pin)} label={copy.verify} onPress={handleVerify} />
    </Screen>
  );
}
