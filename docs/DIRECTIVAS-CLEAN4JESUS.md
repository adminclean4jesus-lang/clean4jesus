...
- Regresión bancaria de 2026-09-17: una allowlist y `android:packageNames` no evitan que NU detecte un servicio de Accesibilidad habilitado. Mantener una ruta visible de Modo banca que invoque `disableSelf()`, conserve la VPN/DNS y abra Ajustes para que el usuario reactive explícitamente la protección. Antes de entregar un APK, validar NU con Accesibilidad activa, pausada y reactivada; nunca pedir desinstalar Clean4Jesus.
...
## PIN Por Correo De Persona De Confianza (16 De Septiembre De 2026)
