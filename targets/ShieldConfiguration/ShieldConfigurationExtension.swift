...
class ShieldConfigurationExtension: ShieldConfigurationDataSource {
    ...
    private func createClean4JesusShieldConfig() -> ShieldConfiguration {
        ...
        return ShieldConfiguration(
            ...
            primaryButtonLabel: ShieldConfiguration.Label(text: defaults?.string(forKey: "customShieldPrimaryLabel") ?? "Volver al inicio", color: UIColor(red: 0.03, green: 0.12, blue: 0.32, alpha: 1.0)),
