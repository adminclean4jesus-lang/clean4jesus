...
class ShieldConfigurationExtension: ShieldConfigurationDataSource {
    ...
    private func createClean4JesusShieldConfig() -> ShieldConfiguration {
        ...
        let subtitleText = defaults?.string(forKey: "customShieldMessage") ?? "Este espacio está reservado para fortalecer tus decisiones y cuidar tu paz espiritual."
        ...
        return ShieldConfiguration(
            ...
            primaryButtonLabel: ShieldConfiguration.Label(text: "Respirar 60 segundos", color: UIColor(red: 0.03, green: 0.12, blue: 0.32, alpha: 1.0)),
            primaryButtonBackgroundColor: UIColor(red: 0.95, green: 0.80, blue: 0.30, alpha: 1.0),
            secondaryButtonLabel: ShieldConfiguration.Label(text: "Cerrar", color: UIColor.white)
        )
    }
}
